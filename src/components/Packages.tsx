...
const css = `
  ...
  /* ── Fade-in reveal (matches Testimonials .pf / .pv) ── */
  ...
  /* ── Section shell — identical black to Testimonials ── */
  .pk-section {
  ...
  /* ── Ambient blobs — same blur(80px) radius system ── */
  .pk-bg-blob {
    position: absolute;
    border-radius: 50%;
    filter: blur(80px);
  ...
  /* ── TABS — glass pill matching card language ── */
  .pk-tabs {
    display: flex;
  ...
  /* ── GRID — 3 glass cards side by side ── */
  .pk-grid {
    display: grid;
  ...
  /* ── CARD — pure Testimonials glass system ── */
  .pk-card {
  ...
  /* selected — stronger glow, brighter border-top */
  .pk-card.selected {
  ...
  /* decorative tier glyph — like Testimonials quotation mark */
  .pk-card::after {
  ...
  /* Primary — solid violet matching site system */
  .pk-btn-primary {
    font-family: 'DM Sans', sans-serif;
    font-weight: 500;
    font-size: .78rem;
  ...
  /* Ghost — glass style matching the cards */
  .pk-btn-ghost {
    font-family: 'DM Sans', sans-serif;
    font-weight: 400;
    font-size: .78rem;
  ...
  return (
    <>
      ...
      <section id="packages" className="pk-section" ref={ref}>
        ...
        {/* Ambient blobs — identical system to Testimonials */}
        ...
        <div className="pk-inner">
          ...
          <div className="pk-grid">
            {group.packages.map((p, i) => {
              const original = p.services.reduce((s, sv) => s + sv.p, 0)
          ...
          <div className="pk-cta">
            <a href="https://wa.me/201067394942?text=Hi%2C%20I%20want%20help%20choosing%20the%20best%20package%20for%20my%20career%20level%20and%20goals." target='_blank' className="pk-btn-primary">
